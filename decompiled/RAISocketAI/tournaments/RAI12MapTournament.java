...
public class RAI12MapTournament
extends RAITournament {
    public RAI12MapTournament(List<AI> list) {
        super(list);
    }
    ...
    public static void main(String[] stringArray) throws Exception {
        ...
        RAI12MapTournament rAI12MapTournament = new RAI12MapTournament(Arrays.asList(aIArray));
        ArrayList<Pair> arrayList = new ArrayList<Pair>();
        arrayList.add(new Pair((Object)"maps/8x8/noBases8x8.xml", (Object)3000));
        arrayList.add(new Pair((Object)"maps/melee14x12Mixed18.xml", (Object)4000));
        arrayList.add(new Pair((Object)"maps/barricades24x24.xml", (Object)5000));
        arrayList.add(new Pair((Object)"maps/BroodWar/(4)BloodBath.scmE.xml", (Object)8000));
        ...
        if (printWriter != null) {
            ((Writer)printWriter).write(rAI12MapTournament.getClass().getName() + ": Starting tournament\n");
        }
        fileWriter.write(rAI12MapTournament.getClass().getName() + "\n");
            ...
            for (int i = 0; i < arrayList.size(); ++i) {
                ...
                for (int j = 0; j < aIArray.length; ++j) {
                    for (int k = 0; k < aIArray.length; ++k) {
                        ...
                        rAI12MapTournament.playSingleGame((Integer)pair3.m_b, 100, -1, 10000L, 1000L, true, true, true, true, unitTypeTable, string2, fileWriter, printWriter, stringArray2, blArray, n, i, physicalGameState, j, k);
                    }
                }
            }
        }
        rAI12MapTournament.printEndSummary(arrayList.stream().map(pair -> (String)pair.m_a).collect(Collectors.toList()), 10, fileWriter, printWriter);
    }
}
